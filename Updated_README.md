...
Thanks to:
- **[bawsdeep](https://github.com/bawsdeep):** Code and UI optimization.
- **[Nox](https://github.com/Noxde/Bloodborne-save-editor):** Explanation of offsets. Check out his Bloodborne editor.
...
1. Clone this repository:
   ```bash
   git clone https://github.com/yourusername/ds3-save-editor.git
   ```
...
1. Launch the application:
   ...
   python main.py
   ```
2. Load your decrypted save file.
3. Modify desired settings and save changes.
...
- **[bawsdeep](https://github.com/bawsdeep):** UI optimization and guidance.
- **[Nox](https://github.com/Noxde/Bloodborne-save-editor):** Insights on offsets and save editing.
